...
async function main() {
  ...
  const data = await prisma.facility.createMany({
    data: [
      { name: "Parkir", icon: "mdi:car" },
      { name: "Shower", icon: "mingcute:shower-line" },
      { name: "Locker", icon: "ph:lockers" },
      { name: "Cafe", icon: "carbon:cafe" },
      { name: "WiFi", icon: "mdi:wifi" },
      {
        name: "Kantin",
        icon: "famicons:restaurant-outline",
      },
      { name: "AC", icon: "tabler:air-conditioning" },
      {
        name: "Ruang Tunggu",
      ...
      { name: "First Aid", icon: "jam:first-aid" },
      { name: "CCTV", icon: "basil:video-outline" },
      {
        name: "Area Penonton",
      ...
      { name: "Lighting", icon: "mage:light-bulb" },
      {
        name: "Sound System",
  ...
  console.log("✅ Seeded provinces:", cities);
}
